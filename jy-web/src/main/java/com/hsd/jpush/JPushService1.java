...
import com.hsd.jpush.util.ErrorCodeEnum;
import com.hsd.jpush.util.IOSExtra;
import com.hsd.jpush.util.JPushClient;
import com.hsd.jpush.util.MessageResult;

public class JPushService1 {

	// 在极光注册上传应用的 appKey 和 masterSecret
	private static final String appKey = "f2ea80cc27abe0e15e50f0aa";//// 必填，例如466f7032ac604e02fb7bda89

	private static final String masterSecret = "913ea29bbc680a296ba3ab17";// 必填，每个应用都对应一个masterSecret
	...
	private static void testSend() {
		...
		// jpush.sendNotificationWithAppKey
