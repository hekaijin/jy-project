						...
						<!-- 				 <div class="form-group">  -->
											<div class="col-xs-4" style="left: 4%;">
												<div class="input-group">
													<input type="text" class="form-control1" style="height:34px;width: 300px;"  id="fieldName" name="fieldName" />
													<div class="input-group-btn">
														<button type="button" class="btn btn-default dropdown-toggle" onclick="putValue('a');" data-toggle="dropdown">
															部门名称 
...
<!-- 											<div class="col-xs-1" style="position: absolute;left: 93%;"> -->
<!-- 												<button id="queryButton" type="button" class="btn btn-default"><span class="glyphicon glyphicon-search"></span>&nbsp;查询</button> -->
...
<!-- 				 <div class="form-group">  
					...
					<div class="col-xs-1" style="position: absolute;left: 30%;">
						<button id="queryButton" type="button" class="btn btn-default"><span class="glyphicon glyphicon-search"></span>&nbsp;查询</button>
<!-- 						<button  type="reset" class="btn btn-default" ><span class="glyphicon glyphicon-repeat"></span>&nbsp;重置</button> 
					</div>	
...
<!-- 							<button class="btn btn-default" id="reverse" name="reverse"><span class="glyphicon glyphicon-check"></span>勾选</button> -->
								...
								<th style="width: 13%;">项目|部门</th>
								<th style="width: 13%;">报销单红线</th>
								<th style="width: 13%;">借支单红线</th>
								<th style="width: 13%;">申请单红线</th>
                        ...
                        <div class="tab-pane active" id="horizontal-form">
                            <form id="form2" class="form-horizontal" action="" method="post" onsubmit="return sub();">
    					 		<div class="form-group mb-n2">
                                    <label for="buildingorientation" class="col-sm-2 control-label label-input-lg" style="padding-right: 0px;">部门</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group mb-n2">
                                    <label for="buildingname2" class="col-sm-2 control-label" style="padding-right: 0px;">报销单红线</label>
                                    <div class="col-sm-8">
                                 ...
                                 <div class="form-group mb-n2">
                                    <label for="buildingname2" class="col-sm-2 control-label" style="padding-right: 0px;">借支单红线</label>
                                    <div class="col-sm-8">
                                 ...
                                 <div class="form-group mb-n2">
                                    <label for="buildingname2" class="col-sm-2 control-label" style="padding-right: 0px;">申请单红线</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group mb-n2">
                                    <label for="buildingname2" class="col-sm-2 control-label" style="padding-right: 0px;">备注</label>
                                    <div class="col-sm-8">
...
function getValueByselect1(text){
	...
	var options = {
		...
		onPageClicked : function(e, originalEvent, type, page) { //页码点击事件
			...
			buildTable(page, currentpage,fieldName);//默认每页最多10条
		}
	}

	//生成表格
	function buildTable(page,currentpage,fieldName) {//page（起始页码）,buildingName（每页记录数）,currentpage（当前页）
		var url = "${basePath}redLine/getRedLineList.html"; //请求的网址 
		var reqParams = {
			'page' : page,
			'fieldName' : fieldName,
			'id':""
...
// 														var td1 = $('<td>'+ (index*1+1)+ '</td>');
														var td1=$('<td><div class="checkboxs" name="sport" value="basketball"><ins><input type="checkbox" style="display:none;" id="check" name="check_id" value="'+this.redlineid+'"/></ins><span></span></div></td>');
														var td122 = $('<td>'+ ((this.fieldName == null) ? '': this.fieldName)+ '</td>');
														var td2 = $('<td>'+ ((this.expensesreimbursementredline == null) ? '': this.expensesreimbursementredline)+ '</td>');
														var td3 = $('<td>'+ ((this.borrowredline == null) ? '': this.borrowredline)+ '</td>');
														var td4 = $('<td>'+ ((this.applyredline == null) ? '': this.applyredline)+ '</td>');
														var td5 = $('<td>'+ ((this.foundperson == null) ? '': this.foundperson)+ '</td>');
														var td6 = $('<td>'+ ((this.createdate == null) ? '': this.createdate.substring(0,this.createdate.length-2))+ '</td>');
														var td7 = $('<td>'+ ((this.remark == null) ? '': this.remark)+ '</td>');
														tr.append(td1);
														tr.append(td122);
														tr.append(td2);
														tr.append(td3);
