...
//														var td4 = $('<td>'+ ((this.applyredline == null) ? '': this.applyredline)+ '</td>');
														var td41 = $('<td>'+ ((this.subscribeRedLine == null) ? '': this.subscribeRedLine)+ '</td>');
														var td42 = $('<td>'+ ((this.predictIncome == null) ? '': this.predictIncome)+ '</td>');
														var td5 = $('<td>'+ ((this.username == null) ? '': this.username)+ '</td>');
