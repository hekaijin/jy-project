...
<body>
    ...
    <div class="content">
        <form action="${basePath }v2/icapply/openalipay.html" class="alipayform" method="POST" target="_blank">
            ...
            <div class="element">
                ...
                <div class="einput"><input type="text" name="WIDsubject" id="WIDsubject" value="test123"></div>
                <br>
			...
			<div class="element">
                ...
                <div class="einput"><input type="text" name="WIDbody" id="WIDbody" value="test"></div>
                <br>
                <div class="mark">注意：商品描述(body)，选填(建议中文，英文，数字，不能含有特殊字符)</div>
            </div>
            <div class="element">
                <input id="sbumitBtn" type="submit" class="alisubmit" value ="确认支付">
            </div>
        </form>
    </div>
    <div id="returnAli" align="left"></div>  
    <div class="footer">  
        <p class="footer-sub">  
